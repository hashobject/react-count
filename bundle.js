	      ...
	      React.createElement("div", {className: "row content"}, 
	        ...
	        React.createElement("ul", {className: "items columns small-12"}, 
	          ...
	          React.createElement("li", {className: "item"}, 
	            ...
	            React.createElement("p", null, "Button that allows to vote/click single time. Information if button was clicked stored in the localStorage."), 
	          ...
	          React.createElement("li", {className: "item"}, 
	            ...
	            React.createElement("p", null, "OnlineCount component behaves as prebious example but has shorter syntax"), 
