	      ...
	      React.createElement("div", {className: "row content"}, 
	        ...
	        React.createElement("ul", {className: "items columns small-12"}, 
	          ...
	          React.createElement("li", {className: "item"}, 
	            ...
	            React.createElement(OnlineCount, {counterText: "views", firebaseHost: "https://counter-button.firebaseio.com/"}), 
	            React.createElement("div", {className: "post"}, 
	              React.createElement("pre", {className: "brush: html"}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OnlineCount = React.createClass({displayName: "OnlineCount",
	  ...
	  render: function () {
	    return (
	      React.createElement(Count, {isOnlineCounter: true, className: this.props.className, counterText: this.props.counterText, firebaseHost: this.props.firebaseHost})
	    )
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElementExtended = __webpack_require__(34);

	var ExecutionEnvironment   = __webpack_require__(32);
	var stylesToCSS            = __webpack_require__(35);
	var assign                 = __webpack_require__(29);
	var isArray                = Array.isArray;
	var generateUniqueCSSClassName = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement  = __webpack_require__(16);
	var assign        = __webpack_require__(29);
	var applyStyles   = __webpack_require__(95);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isUnitlessNumber = __webpack_require__(96).isUnitlessNumber;
	var hyphenateStyleName = __webpack_require__(97);
	var isArray = Array.isArray;
	var keys = Object.keys;
	var unsupportedPseudoClasses = __webpack_require__(98);
