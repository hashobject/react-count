	  ...
	  render: function(){
	    return (
	      React.createElement("div", null, 
	        React.createElement(Count, {className: "button", firebaseHost: "https://counter-button.firebaseio.com/", firebaseResourceId: "counter4"}), 
	        React.createElement(Count, {className: "follow-button button", counterText: "followers", actionText: "follow", allowMultiple: true, firebaseHost: "https://counter-button.firebaseio.com/", firebaseResourceId: "counter6"}), 
	        React.createElement(Count, {counterText: "kudos", firebaseHost: "https://counter-button.firebaseio.com/", firebaseResourceId: "counter7"}), 
	        React.createElement(Count, {isViewCounter: true, counterText: "views", firebaseHost: "https://counter-button.firebaseio.com/", firebaseResourceId: "counter11"}), 
	        React.createElement(Count, {isReadonly: true, counterText: "users", firebaseHost: "https://counter-button.firebaseio.com/", firebaseResourceId: "counter8"}), 
	        React.createElement(Count, {counterText: "likes", actionText: "like", firebaseHost: "https://counter-button.firebaseio.com/", firebaseResourceId: "counter7"})
	      )
	    )
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Kudos = React.createClass({displayName: "Kudos",
	  ...
	  render: function () {
	    ...
	    return (
	      React.createElement("div", {className: className, onClick: this.handleClick}, 
	        ...
	        React.createElement("button", {className: btnClassName, style: buttonStyle}, this.props.actionText)
	      )
	    )
	  }
